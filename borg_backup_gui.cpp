...
{
    QString link = "https://borgbackup.readthedocs.io/";
...
void BORG_BackUP_GUI::on_About_Menu_triggered()
{
    ...
    about.setText("BORG BackUP GUI V 0.1\n\n"
                  "Freely usable for all with the exception of\n"
                  "military and other anti-social activities.\n\n"
