...
// PDF Exporter is still in the development phase.
// Currently only the 1st page can be printed.
...
void BORG_BackUP_GUI::on_About_Menu_triggered()
{
    ...
    about.setText("BORG BackUP GUI V 0.2\n\n"
                  "Attention this GUI is not foolproof,\nthe user is forced to read the manual.\n\n"
                  "Qt (Tools) and this program is provided AS IS with NO WARRANTY OF ANY KIND, INCLUDING THE WARRANTY OF DESIGN, MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.\n\n"
