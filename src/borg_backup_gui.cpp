...
// All image files are stored here in Base64 format.
...
// URL for HELP / GitHub
void BORG_BackUP_GUI::on_url_GitHub_clicked(){
    QDesktopServices::openUrl(QUrl(QString("https://github.com/MTrage/Borg-BackUP-GUI/wiki/Short-instruction")));
}
// URL for HELP / BORG
void BORG_BackUP_GUI::on_url_Borg_clicked(){
    QDesktopServices::openUrl(QUrl(QString("https://www.borgbackup.org/")));
}
