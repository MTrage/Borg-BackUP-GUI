...
void BORG_BackUP_GUI::on_Delete_List_currentRowChanged(int currentRow){
    if(currentRow > -1){
        ...
        QString out = FM(14,"b")        + "Name: "          + FM(0,"end")       + FM(14,"n") + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","name")                                         + FM(0,"end") + hr + tB +
                      trB  + FM(10,"b") + "Host: "          + FM(0,"end") + trM + FM(10,"n") + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","hostname")                                     + FM(0,"end") + trE +
                      trB  + FM(10,"b") + "User: "          + FM(0,"end") + trM + FM(10,"n") + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","username")                                     + FM(0,"end") + trE +
                      trB  + FM(10,"b") + "Comment: "       + FM(0,"end") + trM + FM(10,"n") + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","comment")                                      + FM(0,"end") + trE + tE +
                             FM(8,"b")  + "ID: "            + FM(0,"end")       + FM(8,"n")  + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","id")                                           + FM(0,"end") + hr + tB +
                      trB  + FM(12,"b") + "Start: "         + FM(0,"end") + trM + FM(12,"n") + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","start").replace(".000000","").replace("T"," ") + FM(0,"end") + trE +
                      trB  + FM(12,"b") + "End: "           + FM(0,"end") + trM + FM(12,"n") + read_Borg_Detail_Info_OK(Borg_Detail_Info_OK,"archives","end").replace(".000000","").replace("T"," ")   + FM(0,"end") + trE +
                      trB  + FM(12,"b") + "Last modified: " + FM(0,"end") + trM + FM(12,"n") + read_json_Snapshot_LIST("\"last_modified\":").replace(".000000","").replace("\"","").replace("T"," ")   + FM(0,"end") + trE + tE + hr + tB +
                      trB  + FM(10,"b") + "Original size: "                                                        + FM(0,"end")       + trM  + FM(10,"b") + "Compressed size: "                                                        + FM(0,"end")       + trM  + FM(10,"b") + "Deduplicated size: "                                                        + FM(0,"end")       + trE +
                      trBr + FM(10,"n") + build_json_Snapshot_value(read_json_Snapshot_LIST("\"original_size\":")) + FM(0,"end") + " " + trMr + FM(10,"n") + build_json_Snapshot_value(read_json_Snapshot_LIST("\"compressed_size\":")) + FM(0,"end") + " " + trMr + FM(10,"n") + build_json_Snapshot_value(read_json_Snapshot_LIST("\"deduplicated_size\":")) + FM(0,"end") + " " + trE + tE;
